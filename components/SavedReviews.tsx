    ...
    >
      ...
      <div className="flex gap-3 p-4">
        ...
        <div
          ...
          style={{ width: 80, height: 80, backgroundColor: '#0a0a0a' }}
        >
          {review.thumbnailDataUrl ? (
            ...
            <div className="w-full h-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="#525252" strokeWidth={1.5}>
        ...
        <div className="flex-shrink-0 flex flex-col gap-2 ml-2">
          <button
            ...
            style={{
              ...
              borderColor: expanded ? '#dc2626' : '#3f3f3f',
              color: expanded ? '#fff' : '#a3a3a3',
            }}
          ...
          <button
            ...
            style={{ borderColor: '#3f3f3f', color: '#a3a3a3' }}
      ...
      {/* Expanded analysis */}
      {expanded && (
        <div className="px-4 pb-4 border-t pt-3" style={{ borderColor: '#262626' }}>
...
export default function SavedReviews({ reviews, onDelete }: SavedReviewsProps) {
  if (reviews.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
        <div className="w-16 h-16 rounded-full flex items-center justify-center mb-4" style={{ backgroundColor: '#141414' }}>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="#525252" strokeWidth={1.5}>
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs font-bold tracking-widest uppercase px-1" style={{ color: '#a3a3a3' }}>
